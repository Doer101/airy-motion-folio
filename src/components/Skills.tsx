  ...
  return (
    <section id="skills" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
          {skillCategories.map((category, categoryIndex) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="p-8 card-gradient shadow-soft border-0 hover:shadow-medium transition-smooth">
        ...
        >
          <Card className="inline-block p-8 card-gradient shadow-soft border-0">
            ...
            <p className="text-muted-foreground max-w-md">
              ...
              with industry trends and best practices. Currently diving deep into AI/ML 
              integration and advanced React patterns.
            </p>
          </Card>
        </motion.div>
      </div>
